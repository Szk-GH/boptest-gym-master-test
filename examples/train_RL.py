...
from test_and_plot import test_agent
...
def train_RL(algorithm           = 'DQN',
             start_time_tests    = [(23-7)*24*3600, (115-7)*24*3600],
             # [(16*24*3600,  16*24*3600+14*24*3600), (107*24*3600, 121*24*3600+14*24*3600)],
    ...
    class BoptestGymEnvCustomReward(BoptestGymEnv):
        ...
        def get_reward(self):
            ...
            # objective_integrand = kpis['cost_tot']*12.*16. + 100*kpis
    ...
    if mode == 'train':
        ...
        if 'SAC' in algorithm:
            ...
            env = DiscretizedActionWrapper(env,n_bins_act=10)  # 将每个连续动作维度离散为10个等宽区间
        ...
        callback = SaveAndTestCallback(env, check_freq=1e10, save_freq=1e5,
...
if __name__ == "__main__":
    ...
    env, model, start_time_tests, log_dir = train_RL(algorithm='DQN', mode='train', case='D', training_timesteps=1e6, render=render, expert_traj=os.path.join('trajectories','expert_traj_cont_28.npz'))
