...
def train_RL(algorithm          = 'DQN' ,
    ...
    if mode == 'train':
        model = DQN('MlpPolicy',
                    ...
                    learning_starts=24,   # 训练开始前先收集24步数据填充缓冲区
                    train_freq=2,   # 每1步训练一次网络
...
if __name__ == "__main__":
    ...
    # 训练模型
    env, model, start_time_tests, log_dir = train_RL(algorithm='DQN', mode='train', case='D', training_timesteps=1e5,
